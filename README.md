...
> 本仓库为 baozixiong 保存的 Apple WLOC v1.1.0 镜像，原作者为 Yu9191，原项目为 https://github.com/Yu9191/wloc 。
> 来源：[SourceForge v1.1.0 源码归档](https://sourceforge.net/projects/apple-wloc.mirror/files/v1.1.0/)，上游归档提交：`ecd4992a7c92b7d6e92eb80b948eba54202ab85a`。
> 模块、脚本和图标下载地址已改为本仓库；定位脚本和 Worker 运行逻辑保留原版。
> 当前仅托管源码及订阅文件。在线选点页面、地图链接解析服务和 iCloud 快捷指令仍使用原项目提供的服务，并非本账号部署。
> 本镜像不会自动跟随上游更新。需要自己的在线解析服务时，可按下方说明部署 Worker。
...
**Surge:**
https://raw.githubusercontent.com/baozixiong/wloc/main/modules/wloc.sgmodule

**Quantumult X:**
https://raw.githubusercontent.com/baozixiong/wloc/main/modules/wloc.conf

**Loon:**
https://raw.githubusercontent.com/baozixiong/wloc/main/modules/wloc.lpx

**Stash:**
https://raw.githubusercontent.com/baozixiong/wloc/main/modules/wloc.stoverride

**Shadowrocket(小火箭):**
https://raw.githubusercontent.com/baozixiong/wloc/main/modules/wloc.module
...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/baozixiong/wloc/tree/main/worker)
...
```bash
# 1. 克隆仓库
git clone https://github.com/baozixiong/wloc.git
cd wloc/worker
